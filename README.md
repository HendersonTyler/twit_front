...
[Qminer](https://qminer.github.io/) then tallies up how many times words are used, which is then past onto the front-end for [wordcloud](https://react-wordcloud.netlify.app/) to create a visual representation. Sentiment then calculates a score based on a list of positive or negative words.
